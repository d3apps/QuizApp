package com.dennisdavydov.quizapp.web;
...
import com.dennisdavydov.quizapp.listeners.WebListener;
...
public class WebEngine {
    ...
    public void initWebView(){
        ...
        webView.getSettings().setDefaultTextEncodingName(context.getString(R.string.encoding));

        if (!isNetworkAvailiable(context)){
    ...
    private boolean isNetworkAvailiable(Context context){
